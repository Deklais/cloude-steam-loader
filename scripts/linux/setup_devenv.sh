...
BOOTSTRAP_X86="${BUILD_DIR}/libcloude_bootstrap_x86.so"
BOOTSTRAP_HHX64="${BUILD_DIR}/libcloude_bootstrap_hhx64.so"
MAIN_X86="${BUILD_DIR}/libcloude_x86.so"
LUAVM="${BUILD_DIR}/libcloude_luavm_x86"
