function (find_steam_path project_name)
    if(WIN32 AND CLOUDE_BUILD_TO_STEAM_PATH)
        ...
        if(result EQUAL 0)
            ...
            #   shared libraries  -> <steam>/cloude/lib/
            #   executables       -> <steam>/cloude/bin/
            ...
            if(_target_type STREQUAL "SHARED_LIBRARY" OR _target_type STREQUAL "MODULE_LIBRARY")
                set(_out_dir "${out_steam_path}/cloude/lib")
            else()
                set(_out_dir "${out_steam_path}/cloude/bin")
            endif()
