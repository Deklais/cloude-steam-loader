...
function(cloude_process_package input_path)
...
if(DISTRO_NIX)
    ...
    FetchContent_Declare(luajit SOURCE_DIR "${CLOUDE_BASE}/thirdparty/forks/luajit" SOURCE_SUBDIR fakedir)
    ...
    cloude_process_package("${luajit_SOURCE_DIR}")
    ...
    set(THIRDPARTY_DIR "${CLOUDE_BASE}/thirdparty")
    ...
    if(EXISTS "${curl_SOURCE_DIR}/CMakeLists.txt")
        ...
        string(REPLACE
            ...
            "# patched out by Cloude bootstrap_deps.cmake — manuals not shipped"
    ...
    cloude_process_package("${luajit_SOURCE_DIR}")
    cloude_process_package("${curl_SOURCE_DIR}")
    ...
    cloude_process_package("${nlohmann_json_SOURCE_DIR}")
    cloude_process_package("${minizip_ng_SOURCE_DIR}")
    cloude_process_package("${re2_SOURCE_DIR}")
