...
function(detect_aur_helper result_var)
    ...
    if(NOT PACMAN_EXECUTABLE)
        ...
        set(${result_var} "Couldn't find AUR helper. Please update Cloude manually." PARENT_SCOPE)
        return()
    endif()
    ...
    foreach(helper ${AUR_HELPERS})
        ...
        if(${helper}_EXECUTABLE)
            if(helper STREQUAL "pamac")
                set(${result_var} "pamac upgrade cloude" PARENT_SCOPE)
            elseif(helper STREQUAL "aura")
                set(${result_var} "aura -Ayu cloude" PARENT_SCOPE)
            else()
                set(${result_var} "${helper} -Syu cloude" PARENT_SCOPE)
            endif()
    ...
    message(STATUS "No AUR helper found. Please update Cloude manually.")
    set(${result_var} "Couldn't find AUR helper. Please update Cloude manually." PARENT_SCOPE)
endfunction()