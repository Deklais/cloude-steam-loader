...
This library is used to develop plugins for use with [Cloude Steam Loader](https://github.com/Deklais/cloude-steam-loader).

This repository is an optimistic fork from [Decky Loader's](https://github.com/SteamDeckHomebrew/decky-loader) frontend library for developing plugins ([decky-frontend-lib](https://github.com/SteamDeckHomebrew/decky-frontend-lib)). Decky Loader is a plugin loader for the Steam Deck similar to this project. Cloude's plugin loader portion was heavily inspired by Decky, and it will hopefully serve to extend Decky's existing library and add functionality to portions of the Steam Client that weren't previously supported.
