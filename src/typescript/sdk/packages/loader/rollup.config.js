...
export default {
	...
	plugins: [
		...
		injectProcessEnv({
			CLOUDE_FRONTEND_LIB_VERSION: clientVersion,
			CLOUDE_BROWSER_LIB_VERSION: browserVersion,
			CLOUDE_LOADER_BUILD_DATE: new Date().toISOString(),
		}),
		resolve(),
		commonjs(),
		externalGlobals({
