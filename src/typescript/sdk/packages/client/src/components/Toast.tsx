...
const GamepadUIPopupToast: FC<Omit<ToastProps, 'newIndicator'>> = memo(({ toast }) => {
	return (
		<div
			...
			className={joinClassNames(templateClasses.ShortTemplate, toast.className || '', 'CloudeGamepadUIPopupToast')}
		>
...
const GamepadUIQAMToast: FC<ToastProps> = memo(({ toast, newIndicator }) => {
	...
	return (
		<Focusable
			...
			className={joinClassNames(templateClasses.StandardTemplateContainer, toast.className || '', 'CloudeGamepadUIQAMToast')}
		>
