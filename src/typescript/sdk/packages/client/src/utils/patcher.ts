...
export let callOriginal = Symbol('CLOUDE_CALL_ORIGINAL');
...
function processPatch<Object extends Record<PropertyKey, any>, Property extends keyof Object, Target extends Object[Property]>(
	...
	Object.defineProperty(object[property], '__cloudeOrig', {
		get: () => patch.original,
	...
	object[property].__cloudePatch = patch;
...
function unpatch<Object extends Record<PropertyKey, any>>(patch: Patch<Object>): void {
	...
	while (realObject[realProp] && realObject[realProp] !== patchedFunction) {
		realObject = realObject[realProp].__cloudePatch;
		realProp = 'original';
	...
	realObject[realProp] = realObject[realProp].__cloudePatch.original;
