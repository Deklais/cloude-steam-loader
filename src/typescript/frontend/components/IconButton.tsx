...
interface IconButtonProps {
	/**
	 * Button's class name.
	 * @default "CloudeButton CloudeIconButton MenuBarEditor_IconButton"
	 */
	className?: string;
...
export function IconButton(props: IconButtonProps) {
	...
	const className = joinClassNames('CloudeButton', 'CloudeIconButton', settingsClasses.SettingsDialogButton, props.className ?? '');
...
export function IconButtonWithText(props: IconButtonWithTextProps) {
	...
	const className = joinClassNames('CloudeButton', 'CloudeIconButton', 'CloudeIconButtonWithText', settingsClasses.SettingsDialogButton, props.className ?? '');
	const iconComp = IconsModule[name as keyof typeof IconsModule] ?? 'span';
	const icon = createElement(iconComp as React.ElementType);
